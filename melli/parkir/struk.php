...
if (!$trx) {
        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
            ...
            .box {
                ...
                box-shadow: 0 8px 24px rgba(0,0,0,0.08); width: 100%; max-width: 380px; text-align: center;
            }
    ...
    <body>
        <div class="box">
            ...
            <a href="javascript:history.back()" class="btn">&larr; Kembali</a>
        </div>
    </body>
    </html>
    <?php
...
<head>
<meta charset="UTF-8">
<title>Karcis Parkir #<?= (int) $trx['id_parkir']; ?></title>
<style>
    * { box-sizing: border-box; }
    ...
    .label { width: 42%; }
    .judul { letter-spacing: 2px; }
    .kode-besar { font-size: 20px; font-weight: bold; letter-spacing: 1px; margin: 6px 0; }
    ...
    @media print { .no-print { display: none; } body { margin: 0; width: auto; } }
</style>
</head>
<body>
    <div class="center">
    ...
    <table>
        ...
        <tr><td class="label">Jenis Kendaraan</td><td>: <?= ucfirst(htmlspecialchars($trx['jenis_kendaraan'])); ?></td></tr>
